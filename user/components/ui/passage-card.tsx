...
const PassageCard = (passage: Passage) => {
  const { title, content } = passage;
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-purple-100 rounded-2xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300 flex flex-col gap-2 border border-gray-200 overflow-hidden group">
