  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 h-[80vh] p-4">
      ...
      <div className="flex-1 bg-white rounded-xl shadow-md p-6 overflow-y-auto max-h-full border border-gray-200">
        <h2 className="text-2xl font-bold mb-4 text-blue-700">{passage.title}</h2>        {passage.imageUrl && (
          <img src={passage.imageUrl} alt="Passage image" className="mb-4 max-h-60 rounded shadow" />
        )}
